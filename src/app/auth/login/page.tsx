...
function LoginHandler() {
	...
	useEffect(() => {
		if (session && !isAppLogin) {
			router.push(`${location.origin}/profile`);
		}
	}, [session, isAppLogin]);
					...
					<div className="w-full h-full group p-6 rounded-xl border border-white/10 backdrop-blur-md bg-white/5 transition-all duration-300 shadow-lg">
						...
						<div className="flex flex-col gap-1">
							...
							<p className="text-white/70 text-sm">
								Log In to continue exploring and managing open-source AI apps
								effortlessly.
							</p>
						</div>
					...
					<div className="w-full h-full group p-6 rounded-xl border border-white/10 backdrop-blur-md bg-white/5 transition-all duration-300 shadow-lg">
						...
						<div className="flex flex-col gap-4 mb-6">
							<div className="flex flex-col gap-1">
								...
								<p className="text-white/70 md:text-[13px] text-xs">
									Log in to continue exploring and managing open-source AI apps
									effortlessly
								</p>
							</div>
							<img
								src="https://i.imgur.com/RZ0czGx.png"
								alt="Dione Onboarding"
							/>
						</div>
						...
						<div className="mt-6 w-full h-10 flex gap-2">
							<button
								onClick={() => handleLogin("google")}
								className="rounded-full bg-white/10 w-full p-4 flex items-center justify-center text-white hover:bg-white/20 cursor-pointer transition-colors duration-300"
							>
								<svg
									className="w-5 h-5"
									viewBox="-3 0 262 262"
