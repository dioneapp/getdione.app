...
<nav className="fixed top-0 w-full z-50 px-6 py-4">
  <div className="max-w-7xl mx-auto">
    <div
      className="backdrop-blur-md bg-white/[0.02] border border-white/[0.05] rounded-full px-4 py-3 flex items-center justify-between shadow-lg shadow-black/10"
    >
      <div className="flex items-center gap-3">
        ...
        >
          ...
          <span className="font-semibold text-white group-hover:text-white">Dione</span>
        </a>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        {session ? (
          ...
          >
            {avatarUrl ? (
              <img src={avatarUrl} alt="Profile" className="w-6 h-6 rounded-full" />
            ) : (
  ...
  <div
    id="mobile-menu"
    className="fixed inset-0 bg-black/90 backdrop-blur-md hidden md:hidden z-50"
    aria-modal="true"
    aria-hidden="true"
  >
    <button
