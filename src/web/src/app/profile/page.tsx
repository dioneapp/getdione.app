...
import type { User, ExtendedUser } from '@/types/database'
    ...
    const checkAuth = async () => {
      try {
        ...
        if (sessionError) {
          ...
          throw new Error('Unable to verify your session. Please try logging in again.')
        }
                      ...
                      <div className="flex flex-col gap-1">
                        <input
                          ...
                          onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                            setEditedFields(prev => ({ ...prev, first_name: e.target.value }))
                        ...
                        {fieldErrors.first_name && (
                          <div className="text-red-400 text-sm">{fieldErrors.first_name}</div>
                        )}
                      </div>
                    ) : (
                      ...
                      <div className="flex flex-col gap-1">
                        <div className="flex items-center">
                          ...
                          <input
                            ...
                            onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                              setEditedFields(prev => ({ ...prev, username: e.target.value }))
                        ...
                        {fieldErrors.username && (
                          <div className="text-red-400 text-sm">{fieldErrors.username}</div>
                        )}
                      </div>
                    ) : (
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      <motion.textarea
                        ...
                        onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setEditedFields(prev => ({ ...prev, bio: e.target.value }))}
                  ...
                  <div className="flex items-center gap-2 text-white/50 pt-4 border-t border-white/10">
                    ...
                    {isEditing ? (
                      <motion.input
                        ...
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => setEditedFields(prev => ({ ...prev, location: e.target.value }))}
...
<svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="currentColor"><path d="M160-120q-17 0-28.5-11.5T120-160v-97q0-16 6-30.5t17-25.5l505-504q12-11 26.5-17t30.5-6q16 0 31 6t26 18l55 56q12 11 17.5 26t5.5 30q0 16-5.5 30.5T817-647L313-143q-11 11-25.5 17t-30.5 6h-97Zm544-528 56-56-56-56-56 56 56 56Z"/></svg>
                        Edit Profile
                      </button>
                    </div>
                  )}
...
<svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="currentColor"><path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h240q17 0 28.5 11.5T480-800q0 17-11.5 28.5T440-760H200v560h240q17 0 28.5 11.5T480-160q0 17-11.5 28.5T440-120H200Zm487-320H400q-17 0-28.5-11.5T360-480q0-17 11.5-28.5T400-520h287l-75-75q-11-11-11-27t11-28q11-12 28-12.5t29 11.5l143 143q12 12 12 28t-12 28L669-309q-12 12-28.5 11.5T612-310q-11-12-10.5-28.5T613-366l74-74Z"/></svg>
              Sign Out
            </button>
            <button
