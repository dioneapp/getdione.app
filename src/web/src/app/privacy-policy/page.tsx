        ...
        >
          ...
          <article className="group p-6 rounded-xl border border-white/10 backdrop-blur-md bg-white/5 hover:bg-white/10 transition-all duration-300 shadow-lg">
            ...
            <p className="text-white/80 leading-relaxed">
              ...
              All data is stored securely and processed in accordance with
              industry standards. For more information about Supabase's security
          ...
          <article className="group p-6 rounded-xl border border-white/10 backdrop-blur-md bg-white/5 hover:bg-white/10 transition-all duration-300 shadow-lg">
            ...
            <p className="text-white/80 leading-relaxed">
              ...
              updating the "Updated" date at the top of this policy.
            </p>
          </article>
