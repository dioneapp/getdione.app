...
async function submitForm(formData: FormData) {
    ...
    embeds: [
      {
        ...
        fields: [
          ...
          { name: "Joined Discord", value: discord === "yes" ? "Yes" : "No", inline: true },
        ],
  ...
  const response = await fetch(process.env.NEXT_PUBLIC_BETA_DISCORD_WEBHOOK_URL!, {
    method: "POST",
...
export default function BetaJoin() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      router.push(joinDiscord ? "/beta/success?joinDiscord=true" : "/beta/success");
    } catch (e) {
    ...
    <main>
      ...
      <div className="relative flex flex-col items-center justify-center min-h-[100dvh] px-4 sm:px-8 pt-24 sm:pt-32 pb-16">
        ...
        <h2 className="mt-4 mb-8 max-w-xl text-center text-base sm:text-lg text-white/80 leading-relaxed text-balance px-4">
          Be among the first to try Dione and help shape the future of AI app management.
        </h2>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              >
                ...
                <option value="Data Scientist" className="bg-[#080808]">Data Scientist</option>
                <option value="Researcher" className="bg-[#080808]">Researcher</option>
                <option value="Student" className="bg-[#080808]">Student</option>
                <option value="Business Professional" className="bg-[#080808]">Business Professional</option>
            ...
            <div>
              ...
              >
                ...
                <option value="Beginner" className="bg-[#080808]">Beginner - Just starting out</option>
                <option value="Intermediate" className="bg-[#080808]">Intermediate - Regular user</option>
                <option value="Advanced" className="bg-[#080808]">Advanced - Power user</option>
                <option value="Expert" className="bg-[#080808]">Expert - Professional experience</option>
              </select>
            </div>

            <div>
              <label htmlFor="usage" className="block text-sm font-medium text-white mb-2">
              ...
              >
                ...
                <option value="Personal Projects" className="bg-[#080808]">Personal Projects</option>
                <option value="Professional Work" className="bg-[#080808]">Professional Work</option>
                <option value="Academic Research" className="bg-[#080808]">Academic Research</option>
                <option value="Business Applications" className="bg-[#080808]">Business Applications</option>
                <option value="Learning/Education" className="bg-[#080808]">Learning/Education</option>
              </select>
            </div>
            ...
            <div>
              ...
              >
                ...
                <option value="Windows" className="bg-[#080808]">Windows</option>
                <option value="macOS" className="bg-[#080808]">macOS</option>
                <option value="Linux" className="bg-[#080808]">Linux</option>
              </select>
            </div>
