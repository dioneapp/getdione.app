...
async function submitForm(formData: FormData) {
  ...
  const response = await fetch(process.env.NEXT_PUBLIC_FEATURED_DISCORD_WEBHOOK_URL!, {
    method: "POST",
  ...
  return (
    <main>
      ...
      <div className="relative flex flex-col items-center justify-center min-h-[100dvh] px-4 sm:px-8 pt-24 sm:pt-32 pb-16">
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-xl bg-white/10 backdrop-blur-md rounded-xl p-6 sm:p-8 border border-white/10">
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="tool_name" className="block text-sm font-medium text-white mb-2">Tool Name</label>
              <input
                type="text"
                id="tool_name"
                name="tool_name"
            ...
            <div className="flex gap-4 flex-col sm:flex-row">
              <div className="flex-1">
                <label htmlFor="github" className="block text-sm font-medium text-white mb-2">GitHub URL</label>
                <input
                  type="url"
                  id="github"
                  name="github"
              ...
              <div className="flex-1">
                <label htmlFor="website" className="block text-sm font-medium text-white mb-2">Website</label>
                <input
                  type="url"
                  id="website"
                  name="website"
            ...
            <div className="flex gap-4 flex-col sm:flex-row">
              <div className="flex-1">
                <label htmlFor="contact_email" className="block text-sm font-medium text-white mb-2">Contact Email</label>
                <input
                  type="email"
                  id="contact_email"
                  name="contact_email"
              ...
              <div className="flex-1">
                <label htmlFor="social" className="block text-sm font-medium text-white mb-2">Social Media</label>
                <input
                  type="text"
                  id="social"
                  name="social"
            ...
            <div>
              <label htmlFor="objective" className="block text-sm font-medium text-white mb-2">Tool Objective</label>
              <textarea
                id="objective"
                name="objective"
                required
            ...
            <div>
              <label htmlFor="tags" className="block text-sm font-medium text-white mb-2">Tool Tags</label>
              <input
                type="text"
                id="tags"
                name="tags"
            ...
            <div className="flex gap-4 flex-col sm:flex-row">
              <div className="flex-1">
                ...
                >
                  <option value="" disabled className="bg-[#080808]">Select category</option>
                  <option value="Machine Learning" className="bg-[#080808]">Machine Learning</option>
                  <option value="Natural Language Processing" className="bg-[#080808]">NLP</option>
                  <option value="Computer Vision" className="bg-[#080808]">Computer Vision</option>
                  <option value="Data Analysis" className="bg-[#080808]">Data Analysis</option>
                  <option value="Developer Tools" className="bg-[#080808]">Developer Tools</option>
                  <option value="Other" className="bg-[#080808]">Other</option>
                </select>
              </div>
              <div className="flex-1">
                <label htmlFor="audience" className="block text-sm font-medium text-white mb-2">Target Audience</label>
                <select
                  id="audience"
                  name="audience"
                  required
                  className="w-full px-4 py-2 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-white/50"
                >
                  <option value="" disabled className="bg-[#080808]">Select audience</option>
                  <option value="Developers" className="bg-[#080808]">Developers</option>
                  <option value="Researchers" className="bg-[#080808]">Researchers</option>
                  <option value="Businesses" className="bg-[#080808]">Businesses</option>
                  <option value="Students" className="bg-[#080808]">Students</option>
                  <option value="General Public" className="bg-[#080808]">General Public</option>
                </select>
              </div>
            </div>

            <div>
              <label htmlFor="metrics" className="block text-sm font-medium text-white mb-2">Key Metrics</label>
              <input
                type="text"
                id="metrics"
                name="metrics"
            ...
            <div>
              <label htmlFor="testimonials" className="block text-sm font-medium text-white mb-2">User Testimonials</label>
              <textarea
                id="testimonials"
                name="testimonials"
                rows={3}
            ...
            <div>
              <label htmlFor="reason" className="block text-sm font-medium text-white mb-2">Why Should We Feature Your Tool?</label>
              <textarea
                id="reason"
                name="reason"
                rows={3}
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-3">
                ...
                />
                <label htmlFor="financial_interest" className="text-sm text-white/80">
