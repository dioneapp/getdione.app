...
const footerData = {
  brand: {
    name: "Dione",
    description: "Your gateway to open-source AI applications. Simple, powerful, and community-driven.",
  },
  sections: [
    {
      title: "Quick Links",
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-white">{footerData.brand.name}</h2>
            <p className="text-sm text-white/70">{footerData.brand.description}</p>
                ...
                {links.map(({ href, label, external }) => (
                  <li key={href}>
                    <Link
                      ...
                      className="text-sm text-white/70 hover:text-[#BCB1E7] transition-colors"
                    >
                      {label}
                    </Link>
                  </li>
