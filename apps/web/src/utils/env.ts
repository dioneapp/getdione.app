...
export function getCloudflareEnv(): CloudflareEnv {
	...
	return {
		...
		FEATURED_DISCORD_WEBHOOK_URL: process.env.FEATURED_DISCORD_WEBHOOK_URL || "",
...
export function getWebhookUrl(env: CloudflareEnv, webhookType: 'scripts' | 'featured' | 'beta'): string {
	switch (webhookType) {
		case 'scripts':
