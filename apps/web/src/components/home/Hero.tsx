      ...
      >
        ...
        <div className="flex items-center gap-4 text-sm">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/15 text-white/85 hover:bg-white/10 hover:border-white/25 hover:text-white transition-colors duration-200"
