					...
					<div className="flex items-center gap-8 flex-shrink-0">
						<div className="flex items-center gap-4">
							<button
								ref={menuToggleRef}
								onClick={toggleMenu}
								className="lg:hidden flex items-center justify-center w-9 h-9 rounded-full text-white/80 hover:text-white transition-colors"
							...
							<Link href="/" className="flex items-center gap-2">
								<Image
									...
									priority
								/>
								<span className="font-semibold text-xl text-white">Dione</span>
							</Link>
						</div>
					...
					<div className="hidden md:flex items-center gap-3 flex-shrink-0">
						...
						<div className="flex items-center gap-2">
							...
							<Link
								...
								className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-white/5 border border-white/15 text-white/85 hover:bg-white/10 hover:border-white/25 transition-colors duration-200"
							>
								<svg
									className="w-4 h-4"
									viewBox="0 0 256 199"
